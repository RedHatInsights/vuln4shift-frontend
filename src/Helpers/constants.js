...
export const SEVERITY_OPTIONS = [
  {
    ...
    textColor: 'var(--pf-t--global--icon--color--status--danger--default)',
    hasIcon: true,
  },
  {
    value: 'important',
    label: 'Important',
    iconColor: 'var(--pf-t--global--border--color--nonstatus--orange--clicked)',
    textColor: 'var(--pf-t--global--icon--color--severity--important--default)',
    hasIcon: true,
  },
  {
    value: 'moderate',
    label: 'Moderate',
    iconColor: 'var(--pf-t--global--background--color--highlight--default)',
    textColor: 'var(--pf-t--global--icon--color--severity--moderate--default)',
    hasIcon: true,
  },
  {
    value: 'low',
    label: 'Low',
    iconColor: 'var(--pf-t--global--text--color--subtle)',
    textColor: 'var(--pf-v6-global--default-color--300)',
    hasIcon: true,
  },
  {
    value: 'none',
